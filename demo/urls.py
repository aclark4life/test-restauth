...
urlpatterns = [
    ...
    re_path(
        r"^signup/$", TemplateView.as_view(template_name="signup.html"), name="signup"
    ),
    re_path(
    ...
    re_path(
        r"^login/$", TemplateView.as_view(template_name="login.html"), name="login"
    ),
    re_path(
        r"^logout/$", TemplateView.as_view(template_name="logout.html"), name="logout"
    ),
    re_path(
        r"^password-reset/$",
